...
def main(args):
    ...
    print("   Reclassification Acc with recovery strategy 1(chi-square): %0.2f%%"%(100*acc[0]))
    print("   Reclassification Acc with recovery strategy 2(Reformer): %0.2f%%"%(100*acc[1]))
    print("   Reclassification Acc with recovery strategy 3(Reformer+Decoder+Encoder): %0.2f%%"%(100*acc[2]))
