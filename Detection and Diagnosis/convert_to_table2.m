function [T Mahdis]= convert_to_table2(CPD, domain, evidence)
...
if length(cps) > 0 
  ...
  for i=1:dpsize
    [T(i) Mahdis(i)] = gaussian_prob2(self_val, m(:,i) + W(:,:,i)*cps_vals, C(:,:,i));
  end
else
  for i=1:dpsize
    [T(i) Mahdis(i)] = gaussian_prob2(self_val, m(:,i), C(:,:,i));
  end
end
