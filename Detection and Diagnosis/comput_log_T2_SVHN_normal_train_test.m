function [log_T2_normal,log_T2_test,S,V] = comput_log_T2_SVHN_normal_train_test(x_train_recon,x_test_recon,x_train,x_test)
gtsrb = 0;mnist = 0;svhn = 1;
mixnum = 5;
...
elseif svhn
    NumVari = 3072; NumTrain = 73257; Numtest=26000;
else
    NumVari = 3072; NumTrain = 73257; Numtest=5000;
end
